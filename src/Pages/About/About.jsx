         ...
         <div className="container grid grid-cols-1 md:grid-cols-2 p-6 mx-auto sm:py-12 lg:flex-row lg:justify-between">
            ...
            <div data-aos="fade-right" className=" p-6 rounded-sm ">
               <p className="mt-6 mb-5 text-base text-gray-100 md:pr-8">
                  ...
                  and I specialize in Web Designing and Development. I am
                  working as a full-stack developer for the past years, and I
                  have extensive experience with both front-end and back-end
                  development. I have a deep interest in Web Development and I
                  made some full-stack projects using React, Node, Express, and
                  MongoDB.
               </p>
