        ...
        <ul className="lg:flex items-center hidden space-x-8">
          ...
          <li>
            <a
              href={resume}
              download
              className="block w-full rounded bg-[#eb10bb] px-4 py-2  font-medium text-white shadow hover:bg-[#10eb1f] duration-300 hover:text-gray-800 focus:outline-none  sm:w-auto"
            >
              Get Resume
            </a>
          </li>
